...
╚═╝░░░░░╚═╝╚═╝░░╚═╝╚═╝░░╚═╝░╚════╝░╚═╝░░╚═╝╚═╝░░╚══╝          \033[32;1m                  
  \033[91;1m  ╔════════════════════════════════════════╗
   {H} ║{P}[{H}•{P}] Author    :{warna} MARJAN                {N}{H}║
  {H}  ║{P}[{H}•{P}] Facebook  : {H}MAR JAN          {N}{H}║
    {H}║{P}[{H}•{P}] Whatsapp  : {M}+019*******          {N}{H}║
  {H}  ║{P}[{H}•{P}] Github    : {K}MARJAN XXX{N}    {H}  ║
  {H}  ║{P}[{H}•{P}] Status    : {H}MARJAN XXX {P}     {N}      {H}     ║
...
def mainx():
    ...
    if mahin in ["1","01"]:
     ...
     os.system("xdg-open https://github.com/MARJANX");mainx()
    elif mahin in ["8","08"]:
     os.system("xdg-open https://www.facebook.com/profile.php?id=100082331053953&mibextid=ZbWKwL");mainx()
    elif mahin in ["0","00"]:
     print(f'{gen}{RED}Exited {H}FB-KING {P}Terminal ');os.system("xdg-open https://www.facebook.com/profile.php?id=100082331053953&mibextid=ZbWKwL");time.sleep(3);os.system('xdg-open https://www.facebook.com/groups/fb.king.cyber/?ref=share');exit()
    else:
     print(f"{dot}{M}Don't Select Wrong Options ");os.system("xdg-open https://www.facebook.com/profile.php?id=100082331053953&mibextid=ZbWKwL");mainx()
def mainx2():
    os.system("clear")
    banner()
